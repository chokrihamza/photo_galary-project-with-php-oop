      ...
      <form action="" method="post">
        <div class="col-md-8">
          ...
          <div class="form-group">
            ...
            <input type="text" name="alternate_text" class="form-control" value="<?php echo $photo->caption; ?>">
        ...
        <div class="col-md-4">
          <div class="photo-info-box">
            ...
            <div class="inside">
              <div class="box-inner">
                <p class="text">
                  <span class="glyphicon glyphicon-calendar"></span> Uploaded on: April 22, 2021
                </p>
                <p class="text ">
